...
class ConfigMapper:
    ...
    DESTINATION_MONGO_DB_PORT = os.getenv("DESTINATION_MONGO_DB_PORT")
    DESTINATION_MONGO_DB_NAME = os.getenv("DESTINATION_MONGO_DB_NAME")
    DESTINATION_MONGO_CLUSTER_NAME = os.getenv("DESTINATION_MONGO_CLUSTER_NAME")
    DESTINATION_MONGO_USERNAME = os.getenv("DESTINATION_MONGO_USERNAME")
    DESTINATION_MONGO_PASSWORD = os.getenv("DESTINATION_MONGO_PASSWORD")
    DESTINATION_MONGO_DB_PROTOCOL = os.getenv("DESTINATION_MONGO_DB_PROTOCOL")
